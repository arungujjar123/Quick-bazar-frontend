    ...
    <div className="qb-admin-shell fade-in">
      ...
      <main className="qb-admin-main">
          ...
          >
            ...
            <div className="qb-input-group">
              ...
              <input
                ...
                onChange={(e) =>
                  setShop({ ...shop, contactEmail: e.target.value })
                }
              />
            </div>
            <div className="qb-input-group">
              ...
              <input
                ...
                onChange={(e) =>
                  setShop({ ...shop, contactPhone: e.target.value })
                }
              />
            </div>
          </div>
          <button className="qb-admin-btn-add" style={{ marginTop: "2rem" }}>
            💾 Save Configurations
          </button>
        </section>
        ...
        <section
          ...
          style={{ maxWidth: "800px", marginTop: "2.5rem" }}
        >
          <h3 style={{ marginBottom: "1rem", color: "#ef4444" }}>
            Danger Zone
          </h3>
          <p
            style={{ color: "var(--admin-text-muted)", marginBottom: "1.5rem" }}
          >
