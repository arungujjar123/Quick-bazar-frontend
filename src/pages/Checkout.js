      ...
      <div className="container">
        <header style={{ marginBottom: "3rem" }}>
          ...
          <p style={{ color: "var(--text-muted)", fontWeight: 600 }}>
            Almost there! Complete your payment details to finalize the order.
          </p>
        </header>
        ...
        <form onSubmit={handleSubmit} className="qb-checkout-grid">
          <div className="qb-checkout-steps">
            ...
            <section className="qb-checkout-card">
              <h2>
                <div className="qb-step-number">1</div> Shipping Information
              </h2>
              ...
              <div style={{ marginTop: "2.5rem" }}>
                ...
                <div className="qb-shipping-options">
                  <div
                    className={`qb-shipping-card ${shippingMethod === "standard" ? "active" : ""}`}
                  ...
                  <div
                    className={`qb-shipping-card ${shippingMethod === "express" ? "active" : ""}`}
            ...
            <section className="qb-checkout-card">
              <h2>
                <div className="qb-step-number">2</div> Payment Details
              </h2>
              <div className="qb-payment-methods">
                <button
                  type="button"
                  className={`qb-method-btn ${paymentMethod === "card" ? "active" : ""}`}
                ...
                <button
                  type="button"
                  className={`qb-method-btn ${paymentMethod === "upi" ? "active" : ""}`}
                ...
                <button
                  type="button"
                  className={`qb-method-btn ${paymentMethod === "cod" ? "active" : ""}`}
